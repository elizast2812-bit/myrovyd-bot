...
ВАЖНО: продажи идут все 3 дня вебинара, не только в последний день. Отчёт появляется после 72 часов (после завершения всех 3 дней). Статистика в отчёте — это итог всего 3-дневного цикла.

Ключевые рычаги по блокам:

ТРАФИК (цена лида, регистрации):
- Цена лида растёт → проблема в креативах (выгорел, нет свежих) или аудитории (узкая/широкая)
- Решения: обновить крео, протестировать новые форматы, сменить аудиторию, проверить конверсию лендинга
- Бюджет выше плана → контролировать ежедневный расход, проверить ставки

ДОХОДИМОСТЬ (зрители на вебинарах):
- Доходимость падает → проблема в цепочке прогрева (рассылки не читают, напоминалки не доходят) или низкая вовлечённость после регистрации
- Решения: проверить доставляемость писем/сообщений, обновить тексты напоминалок перед каждым из 3 вебинаров, усилить оффер "зачем приходить именно сегодня"
- Идеи для теста: тетрадь с заданиями и практиками после регистрации (повышает вовлечённость и желание прийти), дополнительный прогревающий урок между регистрацией и первым вебинаром

ЗАЯВКИ И ПРОДАЖИ:
- Мало заявок → слабый оффер на одном или нескольких днях вебинара, аудитория недостаточно прогрета к моменту продажи
- Низкая конверсия в оплату → слабый скрипт продаж, нет дожима между днями и после вебинара, долго обрабатывают заявки
- Решения: усилить офферы на каждом из 3 дней вебинара, добавить дожимающую серию сообщений между днями, ускорить обработку заявок, добавить бонусы за быструю оплату

ДЕНЬГИ:
- ROAS ниже 100% → не окупаем трафик, нужно либо снижать цену лида, либо поднимать конверсии
- Потенциальный ROAS выше факта → есть незакрытые заявки, нужен активный дожим
"""
